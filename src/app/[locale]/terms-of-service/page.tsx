...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Conquest of Azeroth Wiki",
    description: "Read the Terms of Service for Conquest of Azeroth Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Conquest of Azeroth Wiki",
      description: "Terms and conditions for using Conquest of Azeroth Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Conquest of Azeroth Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Conquest of Azeroth Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Conquest of Azeroth Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Conquest of Azeroth Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the PC MMORPG "Conquest of Azeroth" by Ascension. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Class, build, and talent tree guides</li>
              <li>Dungeon, raid, and PvP guides</li>
              <li>Creature and enemy guides</li>
              <li>Achievement walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Conquest of Azeroth Wiki is NOT affiliated with, endorsed by, or associated with
              Blizzard Entertainment, World of Warcraft, or Project Ascension. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Conquest of Azeroth Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Blizzard Entertainment, World of Warcraft, and/or Project Ascension. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Ascension realm updates, patches, and class changes may happen without notice. We are not responsible for in-game changes.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, CONQUEST OF AZEROTH WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Ascension, Discord, social media platforms,
            ...
            <p>
              ...
              you and Conquest of Azeroth Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@conquestofazerothwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@conquestofazerothwiki.wiki</a>
            </p>
            <p>
