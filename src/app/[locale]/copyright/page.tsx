...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Conquest of Azeroth Wiki',
    description: 'Copyright and intellectual property information for Conquest of Azeroth Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Conquest of Azeroth Wiki',
      description: 'Copyright and intellectual property information for Conquest of Azeroth Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Conquest of Azeroth Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Conquest of Azeroth Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Conquest of Azeroth Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Blizzard Entertainment</strong> - Owner of World of Warcraft</li>
              <li><strong>Project Ascension</strong> - Creators of Conquest of Azeroth</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>World of Warcraft</strong> - Trademark of Blizzard Entertainment</li>
              <li><strong>Conquest of Azeroth</strong> - Trademark of the game developers</li>
              <li><strong>Conquest of Azeroth Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Conquest of Azeroth Wiki.
            </p>
            ...
            <p>
              ...
              Conquest of Azeroth Wiki<br />
              Email: <a href="mailto:dmca@conquestofazerothwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@conquestofazerothwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Conquest of Azeroth Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Conquest of Azeroth Wiki (conquestofazerothwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@conquestofazerothwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@conquestofazerothwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@conquestofazerothwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@conquestofazerothwiki.wiki</a>
            </p>
            <p>
