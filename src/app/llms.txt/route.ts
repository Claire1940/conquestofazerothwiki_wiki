...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.conquestofazerothwiki.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Conquest of Azeroth Wiki'
